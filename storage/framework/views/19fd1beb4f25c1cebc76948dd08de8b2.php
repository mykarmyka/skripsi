        ...
        <div class="register-body">
            <form method="POST" action="<?php echo e(route('user.register.submit')); ?>">
                ...
                <div class="register-footer">
                    <p class="register-login-link-footer">Sudah punya akun? <a href="<?php echo e(route('user.login')); ?>">Login di sini</a></p>
...
<?php /**PATH C:\xampp\htdocs\klinik-bidan\resources\views/user/register.blade.php ENDPATH**/ ?>