                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="no_telp" class="form-control" pattern="08[0-9]{8,11}" value="<?php echo e($profil->telp); ?>" required>
                        </div>
                        <div class="col-md-6">
...
<?php echo $__env->make('user.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik-bidan\resources\views/user/profil.blade.php ENDPATH**/ ?>