...
document.addEventListener('DOMContentLoaded', function () {
    ...
    modal.addEventListener('shown.bs.modal', function () {
        ...
        fetch("<?php echo e(route('admin.laporan.ajax')); ?>?" + new URLSearchParams(formData))
            .then(res => res.text())
            .then(html => {
                ...
                // update PDF link
                const pdfUrl =
                    "<?php echo e(route('admin.laporan.pdf')); ?>?" +
                    new URLSearchParams(formData);

                document
                    .querySelector('#laporanModal .btn-success')
                    .setAttribute('href', pdfUrl);
            })
            .catch(err => {
                loading.innerHTML =
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skripsi\resources\views/admin/laporan.blade.php ENDPATH**/ ?>