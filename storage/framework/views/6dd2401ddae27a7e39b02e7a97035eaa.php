...
<div class="container bg-white p-5 rounded shadow">
    ...
    <form id="formPendaftaran" action="<?php echo e(route('user.pendaftaran.simpan')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('user.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik-bidan\resources\views/user/pendaftaran.blade.php ENDPATH**/ ?>